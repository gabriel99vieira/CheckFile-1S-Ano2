...
PROGRAM_OBJS=main.o debug.o memory.o $(PROGRAM_OPT).o message.o colors.o file_helper.o string_aux.o checkfile.o
...
string_aux.o: string_aux.c string_aux.h
checkfile.o: checkfile.c checkfile.h
